...
library(ggplot2)
library(grid)
source("~/Dropbox/Works/Class/Case_studies_in_stat/R.WD/Doorae_Class/R/theme_kr_ASGN.R")
...
box.5 <- box.4 + annotate("text", x=c(1, 2), y=c(12.2, 13), label=c("예그리나", "아름다운인제관광"), size=3.5, family="Apple SD Gothic Neo")
box.5
```
