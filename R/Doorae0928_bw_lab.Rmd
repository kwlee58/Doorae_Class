...
getwd()
load("~/Dropbox/Works/Class/Case_studies_in_stat/R.WD/Doorae_Class/R/doorae_new1015.rda")
load("~/Dropbox/Works/Class/Case_studies_in_stat/R.WD/Doorae_Class/R/coord.rda")
# library(xtable)
# library(stargazer)
library(knitr)
# library(tables)
...
(box.5 <- box.4 + annotate("text", x=c(1.5, 2.3), y=c(12.3, 11.7), label=c("예그리나", "아름다운인제관광"), size=3.5, family="HCR Dotum"))
#box.5
```
