...
load("V:/Works/Class/Case_studies_in_stat/R.WD/Doorae_Class/R/doorae_new1015_win.rda")
load("V:/Works/Class/Case_studies_in_stat/R.WD/Doorae_Class/R/coord.rda")
library(knitr)
library(extrafont)
# loadfonts()
...
library(ggplot2)
library(grid)
source("V:/Works/Class/Case_studies_in_stat/R.WD/Doorae_Class/R/theme_kr_Dotum.R")
